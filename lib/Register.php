<?php
    ...
    class Register extends Model {
        ...
        public function Last($lim = false) 
        {
            ...
            $res = $this->db->query("INSERT INTO `" . self::TABLE . "` '".$login."' '".$password."' '".$name."' '".$adres."' '".$category."' '".$specialization."' '".$financing."' '".$number."' ORDER BY time DESC LIMIT " . $lim)->fetchAll(PDO::FETCH_ASSOC);
